...
import com.stark.video.chat.ui.pinterest.internal.PLA_AbsListView;
import com.stark.video.chat.ui.pinterest.internal.PLA_ListView;
...
public class MultiColumnListView extends PLA_ListView {
	...
	public OnScrollListener scroller = new OnScrollListener() {
		...
		public void onScrollStateChanged(PLA_AbsListView view, int scrollState) {
			...
			System.out.println("---scrollState:" + scrollState + " visibleLastIndex:" + visibleLastIndex + " loadingMoreComplete:" + (loadingMoreComplete ? "true" : "false"));
